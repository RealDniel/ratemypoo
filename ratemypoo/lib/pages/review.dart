...
class ReviewForm extends StatefulWidget {
  ...
  const ReviewForm({super.key, required this.markerId});
  ...
  Future<void> _submitReview() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('reviews').add({
        ...
        'rating': _rating,
        'latitude': 0.0,  // Replace with actual marker's position
        'longitude': 0.0, // Replace with actual marker's position
